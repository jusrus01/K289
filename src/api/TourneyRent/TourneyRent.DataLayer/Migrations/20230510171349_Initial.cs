        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionReason = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankAccountNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TransactionReason = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsWinnerSelected = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FirstName", "ImageId", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TeamId", "TwoFactorEnabled", "UserName" },
                values: new object[] { "2f2c8f88-466a-46a7-973e-2e846effdf24", 0, "d9613afe-bf71-4011-ab09-10540da12750", "admin@admin.com", false, "Vardenis", null, "Pavardenis", false, null, "ADMIN@ADMIN.COM", "ADMIN@ADMIN.COM", "AQAAAAEAACcQAAAAENlhkWeGcBe8J95nTzkIaLj9eD0pR7vaJ4+89LD2P0HMrraG2ZvpWiBn1+hpn9NA3A==", null, false, "37QVYJOLLDOSH5MWJSLBOWGDCAXPT2QA", null, false, "admin@admin.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("5019d333-9a5d-4fbc-b691-4ac63b34ba24"), "Gaming monitor", null, "KOORUI 24.5 Inch FHD Gaming Monitor (used)", null },
                    { new Guid("8f2ccee9-34fb-422c-9b47-fb0eecb002dd"), "Laptop", null, "Dell Latitude 3520 Laptop 15.6 (used)", null },
                    { new Guid("f062a606-ac3c-40c2-807e-d13ef2bd1218"), "Gaming monitor", null, "DELL Latitude 5490 (used)", null }
                });
